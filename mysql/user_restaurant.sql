...
CREATE TABLE `user_restaurant` (
  ...
  CONSTRAINT `user_restaurant_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `user` (`User_ID`),
  CONSTRAINT `user_restaurant_ibfk_2` FOREIGN KEY (`Restaurant_ID`) REFERENCES `restaurant` (`Restaurant_ID`)
